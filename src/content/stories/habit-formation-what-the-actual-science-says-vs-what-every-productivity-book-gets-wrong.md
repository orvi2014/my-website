...
You have never broken a bad habit. You have only ever moved to a place where it couldn't reach you.
...
A habit book that tells you three weeks stands between you and a new identity is a better product than one that tells you it might take eight months and there's no way to know in advance. The Lally finding is inconvenient in the way true things about behavior often are: it refuses to promise you a date. I think this is where most people's engagement with the research stops. At "okay, it's longer than I thought, better pace myself." That was where mine stopped too, the first several times I read about this study. It took writing about it directly to notice I'd absorbed the correction without absorbing what the correction was actually describing.

## What Is Actually Happening During Those 66 Days?

You're not building willpower. You're building an association strong enough that the behavior stops needing a decision at all, and by some estimates, over a third of what you do in a given day already works this way.

Wendy Wood's research group, in a pair of diary studies where participants reported their behavior hour by hour, found that somewhere between 35% and 43% of daily actions were performed in the same context almost every day, with little conscious deliberation involved, habitual, by the study's own definition ([Wood, Quinn & Kashy, 2002, *Journal of Personality and Social Psychology*](https://pubmed.ncbi.nlm.nih.gov/12500811/)). Their conclusion, stated almost offhandedly in the paper, is one I've come back to more than almost any other line in this literature: between a third and a half of what you do today, you are not really deciding to do.
...
This is the finding that changed how I think about the whole subject, and it's the one habit books almost never mention, because it doesn't flatter the "build better systems" narrative. Between 1971 and 1974, sociologist Lee Robins tracked U.S. servicemen returning from Vietnam, where roughly 20% had become addicted to heroin, a staggeringly high rate, built on daily use under extreme stress in a specific physical and social environment. The expectation, based on everything known about addiction relapse at the time, was that most would relapse at home. Instead, addiction rates collapsed to around 1% within a year of return ([Robins, 1974, *American Journal of Public Health*](https://ajph.aphapublications.org/doi/pdf/10.2105/AJPH.64.12_Suppl.38)). Not because these men had more discipline than typical addicts. Domestic heroin users at the time relapsed at rates of 80–90%. Because the cues were gone. The specific base, the specific unit, the specific danger, the specific dealer, the specific boredom, all of it stayed in Vietnam.
...
Lally's team found something that should have made this obvious earlier: missing a single day of the target behavior "did not materially affect the habit formation process." One skipped run, one skipped glass of water, barely mattered to the eventual automaticity curve. That's the opposite of fragile. A habit under construction can absorb a bad day, a sick week, a missed Tuesday, and keep climbing toward automatic. What it cannot absorb is the disappearance of the cue that anchors it. Skip the run, fine. Move to a city with no park, no running partner, no morning light through that window, and the habit doesn't get skipped, it gets orphaned.
...
What I haven't resolved, and I don't think the research resolves either, is what this means for identity, the part of the pitch every habit book leans on hardest, the idea that repeated behavior becomes who you are. If Robins's veterans could shed a heroin habit almost entirely within a year of losing its cues, and if a third to a half of what any of us does today is running on autopilot wired to a room rather than a self, then how much of "who you are" is actually just an inventory of which rooms you've spent the most time in. I don't have a tidy answer to that. I'm not sure automaticity and identity are the same thing wearing different names, or whether identity is the story we tell afterward about a cue-response loop that never needed a story at all. That part I'm still working through.
---
title: "Kahneman Was Right: Why System 1 Still Wins Every Product Decision"
description: "Kahneman product design explained through Snapchat's 2018 redesign and New Coke — why the fast, automatic brain beats every data-backed plan."
pubDate: 2026-06-02
category: "psychology"
author: "Orvi"
readingTime: 9
tags: ["kahneman", "product design", "behavioral psychology", "system 1", "ux", "snapchat", "new coke", "decision making"]
featured: false
---
...
Here is the layer most retrospectives miss. The popular story is that the redesign was "confusing." Over 1.2 million people signed a [Change.org petition](https://money.cnn.com/2018/02/22/technology/snapchat-update-kylie-jenner/index.html) demanding the old version back, and the press ran with "users hate change." But that framing locates the failure in System 2 — in conscious evaluation, in users weighing the new layout against the old and deciding they preferred the old. That's not what happened.
...
The numbers confirm the diagnosis arrived in the body, not just the sentiment. In Q2 2018, Snap reported its [first-ever decline in daily active users](https://techcrunch.com/2018/08/07/snapchat-earnings-q2-2018/), falling 2 percent from 191 million to 188 million. Management's own attribution was blunt: the drop was driven by lower usage, "primarily due to the redesign."
...
Kahneman died in March 2024. He spent a career proving that humans are not the deliberate, rational agents our models assume, and that the fast, automatic mind quietly runs the show. The product graveyard — New Coke, the Snapchat redesign, and the hundreds of quieter failures that never make the news — is just that thesis, repeated, in the language of lost market caps. The companies that survive the next redesign won't be the ones with the most data. They'll be the ones who finally understand which system they're designing for, and stop measuring the sip when the relationship is what's on the table.
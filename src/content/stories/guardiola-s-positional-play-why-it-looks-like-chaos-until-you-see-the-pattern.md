...
author: "Orvi"
readingTime: 10
tags: ["Guardiola", "positional play", "Manchester City", "tactics", "John Stones", "Rodri", "counterpressing", "half-spaces", "Champions League", "Real Madrid"]
featured: false
---
...
Here's the tell. The thing that turned a very good City into the 2022-23 treble winners was not a new attacking idea. It was John Stones. [The Analyst](https://theanalyst.com/articles/john-stones-centre-midfield-centre-back-hybrid-role), Opta's own outlet, documented the hybrid role precisely: Stones defended as a right-sided centre-back in a back four, then stepped into a double pivot beside Rodri the instant City had the ball, morphing the nominal 4-3-3 into a 3-2-4-1 in build-up. Read the purpose of that. A converted centre-back is being inserted into *midfield* — not to create more chances, but to screen the centre, to choke the lane an opponent would counter through. It is an attacking shape engineered around a defensive fear: the transition.
...
For the season, City circulated the ball with a Premier-League-leading share around **65% average possession** ([FBref, 2022-23](https://fbref.com/en/squads/b8fd03ef/2022-2023/all_comps/Manchester-City-Stats-All-Competitions)). The consensus reads that number as the goal. I read it as the symptom — the visible exhaust of a structure built primarily to deny the opponent the ball and the transition.

...
author: "Orvi"
readingTime: 11
tags: ["gegenpressing", "Jurgen Klopp", "PPDA", "Liverpool", "tactics", "rest defense", "Roberto Firmino", "high press", "Real Madrid", "positional play"]
featured: false
---
...
Gegenpressing, or counter-pressing, is the act of immediately swarming the ball after losing it to win it back high up the pitch before the opponent can launch an attack. Klopp's own framing is the cleanest one ever given: "No playmaker in the world can be as good as a good counter-pressing situation." The logic is that a turnover near the opponent's goal is one pass from a chance, so the press becomes your creative engine rather than your safety net ([Sky Sports](https://www.skysports.com/football/news/11661/11729575/why-jurgen-klopps-gegenpressing-with-dortmund-was-revolutionary)).
...
## What is a good PPDA in football?

A PPDA under 10 is elite pressing, roughly 10 to 13 is the ordinary Premier League range, and anything above about 15 describes a side that concedes the ball and defends deep. PPDA — passes per defensive action — divides the passes an opponent completes by the number of tackles, interceptions, challenges and fouls you make in the attacking 60 percent of the pitch, so a lower number means you let the opponent string together fewer passes before you bite ([Premier League](https://www.premierleague.com/en/news/4250153/passes-per-defensive-action-explained)).

In 2024/25, Liverpool posted a league-low PPDA of 9.89 — the most aggressive press in England, and they won the title with it. Under Klopp at his peak the figure sat around 7 to 8, which is close to the practical floor of the metric: press any harder than that and the number stops measuring aggression and starts measuring desperation ([Coaches' Voice](https://learning.coachesvoice.com/cv/ppda-explained-passes-per-defensive-action/)).

The benchmark is the easy part. What the number cannot tell you is whether the press was earned or gambled.
...
Rest defence is the positioning of your deepest players *while your own team still has the ball* — the staggered safety net left behind the attack so that a turnover meets bodies rather than open space. It is the hidden half of gegenpressing: the counter-press is only possible when the shape to counter-press from is already standing there.

When Liverpool attacked in their 2018–19 and 2019–20 vintage, Fabinho sat as a lone screen ahead of the centre-backs, and the moment the ball was lost he was already in the lane the opponent wanted to counter through. The counter-press worked because Fabinho had never left. At City, Rodri does the identical job; his positional discipline, not Erling Haaland's finishing, is what lets City press 35 yards from the opponent's goal without bleeding transitions.

Take Rodri out and the whole structure that the press depends on collapses. City found out in 2024/25: he ruptured his cruciate ligament in September 2024, and the side that had won four straight titles finished third on 71 points, 13 behind Liverpool. The press looked the same. The net behind it did not.

## Which players make gegenpressing work?
...
## Why did Liverpool's gegenpressing stop working?

Because the structure underneath it decayed while the intensity stayed exactly the same. That is also the answer to the obvious objection — that Klopp and Pep prove intensity wins — because you can watch what happens when the running survives and the shape does not.
...
## Is gegenpressing still worth copying?

Yes — but only the half almost nobody copies. Gegenpressing is not a pressing system. It is a *possession* system whose most important work happens before the ball is lost, executed by a single pivot and a pressing forward that highlight culture renders invisible. The running everyone copies is the last and least important step.
...
Gegenpressing is the counter-idea that ended the dominance of the possession sides ranked in [football's all-time greatest teams](/chapters/football/greatest-football-teams-of-all-time).
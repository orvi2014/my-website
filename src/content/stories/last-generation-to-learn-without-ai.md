---
title: "What Learning Without AI Taught the Last Pre-AI Generation"
description: "Learning without AI built deep understanding through friction — what the last pre-AI generation carries that AI-native learners may never develop."
pubDate: 2026-05-16
category: "future"
author: "Orvi"
readingTime: 7
tags: ["AI", "learning", "education", "future", "generation", "skills", "artificial intelligence", "knowledge", "human development", "critical thinking"]
featured: false
---
...
It builds structural understanding — the ability to recognize not just the answer, but why the wrong approaches were wrong. That kind of knowledge is built only through a problem actively resisting you, not through being handed the solution.
...
[Cognitive science calls this desirable difficulty](https://www.learningscientists.org/blog/2016/4/21-1) — the finding that learning is more durable when it requires effort. UCLA psychologist Robert Bjork, who coined the term in the 1990s, demonstrated that introducing manageable obstacles during practice produces better long-term retention than frictionless instruction. Problems that are easy to solve are easy to forget. Problems that cost you something tend to stay.

The same pattern shows up under controlled conditions. In a [2008 study published in Science](https://www.science.org/doi/abs/10.1126/science.1152408), Karpicke and Roediger had students learn foreign-language vocabulary, then compared repeated studying against repeated testing. Repeated studying after the first correct recall had no measurable effect on what students remembered a week later. Repeated testing — the harder, more effortful path — produced a large, lasting improvement. The students who found testing more effortful also predicted they would remember less. They were wrong. Effort during learning, not exposure to the material, was what predicted retention.
...
The AI systems being built today were trained on content produced by people who learned without AI. The code on [GitHub](https://github.com), the explanations on [Stack Overflow](https://stackoverflow.com), the documentation written by people who understood systems through years of working with them — this is what current AI knows.

That data captured something: the thinking of humans who built their understanding through friction.

The data being generated now is different. Developers who use AI agents think differently. They reach for a prompt before they reach for a solution. They work in handoffs and reviews rather than line-by-line construction. A [2023 study published in the Communications of the ACM](https://cacm.acm.org/research/measuring-github-copilots-impact-on-productivity/) found developers using GitHub Copilot completed tasks 55% faster than those working unassisted — a speed gain that inevitably reshapes how problems are approached before they are even fully understood. The texture of that work is changing too: GitHub reported in 2023 that Copilot was already writing [around 46% of code](https://github.blog/news-insights/research/the-economic-impact-of-the-ai-powered-developer-lifecycle-and-lessons-from-github-copilot/) in files where it was enabled. This is not worse. But it is a different cognitive texture, and that texture is becoming the training data for the next generation of models.

We are not, in any simple sense, training AI on human thought anymore. We are training AI on human thought that has already been shaped by AI. Researchers have already given this feedback loop a name and a failure mode: a [2024 study in Nature by Shumailov et al.](https://www.nature.com/articles/s41586-024-07566-y) found that models trained repeatedly on data generated by earlier models degrade in a process they call "model collapse" — rare patterns vanish first, then errors compound across generations until output quality breaks down irreversibly. The feedback loop is closed. Nobody fully knows what it produces in human cognition, but we already have evidence of what it does to machines.

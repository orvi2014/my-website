...
A 2024 study from Google found that developers using AI coding assistants completed simple, well-defined tasks 55% faster than a control group, but showed no statistically significant improvement on debugging or architectural design tasks. That matches my experience almost exactly. The productivity gains are real and worth having. They are just not uniformly distributed across a developer's actual work.
...
The strangeness appeared around four months in, during code review. My own code review, reviewing my own work the next morning.
...
Most productivity surveys ask about speed and output volume. They don't ask what happens to your sense of ownership over time, or whether you still feel like the author of something you built quickly. The Stack Overflow Developer Survey 2024 found that 76% of developers were using or planned to use AI tools, but the survey questions focused almost entirely on speed and code quality, not on how the work *felt* from the inside.
...
Being less exhausted by the boring parts also means more attention left for the parts that actually need it. The Uplevel 2024 developer productivity report noted that developer fatigue reduction was cited more frequently than raw speed as a benefit by engineers using AI tools daily. That matches what I noticed: the gain wasn't always "I finished faster," it was "I still had energy to think properly at the end."

## What stayed exactly the same?

The decisions that actually matter took the same amount of time, sometimes longer, even after a full year of AI assistance.
...
Use AI assistance for the parts of your work that feel like *translation*, where you know exactly what you need and you're simply expressing it in syntax. Don't use it as a thinking partner for genuinely novel problems without understanding that confident, fluent output is not the same as correct output.
...
**Further reading:** [Stack Overflow Developer Survey 2024](https://survey.stackoverflow.co/2024/ai) on AI tool adoption among developers. [Uplevel's 2024 Developer Productivity Report](https://uplevelteam.com/resources/developer-productivity-report) on fatigue reduction vs. speed gains.

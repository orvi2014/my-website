---
title: "Why Do Teams Play a High Defensive Line? The Tactic Explained"
description: "Why do teams play a high defensive line? Everyone says it's beaten by pace in behind. The match data says we've spent a decade blaming the wrong thing entirely."
pubDate: 2026-06-17
category: "football"
author: "Orvi"
readingTime: 11
tags: ["high defensive line", "tactics", "Bayer Leverkusen", "Xabi Alonso", "Liverpool", "offside trap", "gegenpressing", "William Saliba", "Premier League", "pressing", "low block", "Arsenal"]
featured: false
---
...
Look at Bayer Leverkusen's Invincible season. Alonso's side went the entire 2023-24 Bundesliga unbeaten — 28 wins, six draws, zero defeats, 90 points — and conceded just 24 goals, the fewest in the division and a club record, per the [Bundesliga's own season data](https://www.bundesliga.com/en/bundesliga/news/numbers-behind-2023-24-season-records-best-statistics-leverkusen-kane-27492). That is 0.7 goals against per game across a 34-game league season. They did this with one of the highest, most aggressive lines in Europe. Alonso's 3-4-2-1 used Jonathan Tah and Edmond Tapsoba as stepping centre-backs who would jump into midfield to kill a pass before it was played, with Granit Xhaka screening as the deep *pivot* and Florian Wirtz operating as a *free 8* between the lines. The wing-backs Jeremie Frimpong and Alejandro Grimaldo lived in the opposition half.

And the run was not a league-only fluke. Leverkusen went [51 games and 361 days unbeaten across all competitions](https://www.cbssports.com/soccer/news/bayer-leverkusens-51-game-unbeaten-run-snapped-in-3-0-loss-to-atalanta-in-europa-league-final/) — the longest unbeaten streak in European football since the Second World War — before Atalanta finally beat them 3-0 in the Europa League final on 22 May 2024. You do not concede the fewest goals in a major league, [across a 34-game unbeaten season](https://en.wikipedia.org/wiki/2023%E2%80%9324_Bayer_04_Leverkusen_season), by accident at the back. You do it because a high line plus coordinated pressing starves the opponent of the ball in dangerous areas.
...
## Does pace really beat a high defensive line?
...
Go back to Villa Park. The received wisdom says Watkins' pace beat Liverpool's line. Watch the build-up instead. The recurring problem, as the tactical breakdowns of that game noted, was that Andy Robertson and Trent Alexander-Arnold were pushed high to press, leaving Liverpool's remaining defenders [three-against-four when Villa broke](https://www.holdingmidfield.com/case-study-aston-villa-7-2-liverpool-4-10-2020-tactics-tactical-analysis/), and — crucially — the line kept stepping up *even when nobody was closing the man on the ball*. Grealish had a free head and a free foot. Give any Championship No. 10 time and an open lane, and a striker running onto a perfectly weighted through ball will beat any line in the world. That is not a pace problem. That is a *press-trigger* problem: the front line did not engage, so the back line stepped into a trap it had set for itself.

The through ball is football's most lethal pass precisely because it is so rarely available. Analytics FC's study of Premier League through-balls found they produce a shot roughly [once every four attempts and a goal about once every 15](https://analyticsfc.co.uk/blog/2022/08/25/through-balls-in-the-premier-league-creators/) — devastating efficiency, which is exactly why a functioning press is built to deny the *time* to attempt one. **The footrace is the autopsy, not the cause of death.** When you see a striker clean through, you are not watching the line fail. You are watching the pressing structure that should have prevented the pass fail one beat earlier.
...
Notice what none of these require: a 10.9-second 100-metre runner. They require a *passer* with time and a *runner* with timing. **A high line is not beaten by legs; it is beaten by a free man with his head up.** Take away the passer's time — which is the entire job of *gegenpressing* and a low *PPDA* (passes allowed per defensive action; the lower the number, the more relentlessly you press) — and the runner's timing is irrelevant because the pass never arrives.

## Is the offside trap too risky to rely on?

No — the numbers say the opposite, because the best high lines win the offside duel by a landslide. In 2021-22, Liverpool's back line caught opponents offside 144 times, [the most by any Premier League team in at least seven seasons](https://anfieldindex.com/56998/the-one-stat-which-defines-jurgen-klopps-liverpool.html), and through the first 27 games of that campaign they were springing the trap [4.1 times per match to Manchester City's 2.5](https://www.planetfootball.com/in-depth/liverpool-jurgen-klopp-offside-trap-high-line-defence-var-genius-chelsea-burnley).

Think about what that figure represents. Every one of those 144 flags is a promising attack extinguished for free — no tackle, no foul, no foot put in, just an arm raised. **The offside trap is the only defensive action in football with a near-zero physical cost and a 100 percent success rate when it works.** The handful of times it fails are spectacular and memorable; the 144 times it works are forgotten by Monday. That asymmetry is the engine of the entire myth. We remember Watkins clean through. We do not remember the four times that same afternoon a striker was flagged a yard off. Availability bias, not arithmetic, built the case against the high line.

And the counts move with execution, not with philosophy. Across the six seasons before 2022-23, Liverpool averaged 118 opponents caught offside and never dropped below 95. In 2022-23, with the same manager and the same instruction but a midfield that no longer pressed on cue, the figure fell to 88 — and that was the season the goals started leaking. The trap did not get riskier. The team in front of it stopped doing its job.

## Why does a high defensive line look so fragile?
...
## Is a low block safer than a high defensive line?

No — a low block does not remove risk, it relocates it, and the deepest-defending sides are consistently among the worst defensive records in a league. The obvious rebuttal to everything above is that even if the high line concedes fewer chances on average, the goals it does concede are so damaging that the variance isn't worth it — better to sit in a *low block*, defend the box, and take your chances. It is a reasonable-sounding objection that the data dismantles.

Sitting deep invites 25 shots, concedes a stream of crosses and cutbacks, and surrenders territory and the ball. Look at where that ends. Sheffield United in 2023-24 defended as deep as anyone in England and shipped [104 goals, the most any club has conceded in a Premier League season](https://theanalyst.com/2024/05/most-goals-conceded-premier-league-season/) — 2.7 per game. Leverkusen, in the same season, conceded 24 by refusing to let opponents reach their box at all. That is a factor of more than four between the deepest block and the highest line, and it runs in the opposite direction to the myth.

The high line's "variance" is a feature of *bad* high lines, the ones without the press in front and the organiser within. **A well-run high line is not high-variance; it is the lowest-variance defensive system in the modern game, because it kills attacks before they become chances.** The variance lives in the gap between the idea and the execution — and that gap is closed by coaching, by a *press trigger* everyone obeys, and by a Saliba or a Tah who never steps alone.
...
## Where does the high defensive line fit into football's bigger tactical argument?

It is the bet that makes pressing possible: without a line pushed up, there is no compact block to press inside, and the whole system collapses into chasing. It is also the specific flaw that pushed Spain down [the ranking of football's greatest teams](/chapters/football/greatest-football-teams-of-all-time).
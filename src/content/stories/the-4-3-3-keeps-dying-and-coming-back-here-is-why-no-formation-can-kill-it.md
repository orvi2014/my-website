...
author: "Orvi"
readingTime: 10
tags: ["4-3-3", "false 9", "tactics", "Lionel Messi", "Pep Guardiola", "Jurgen Klopp", "Barcelona", "Liverpool", "gegenpressing", "El Clasico"]
featured: false
---
...
By running the exact opposite instructions through the exact same skeleton — a vertical, gegenpressing 4-3-3 that turned Guardiola's patient possession version inside out. On 7 May 2019 at Anfield, Klopp's Liverpool overturned a 3-0 first-leg deficit to win 4-0, advancing 4-3 on aggregate ([uefa.com](https://www.uefa.com/uefachampionsleague/season=2019/matches/round=2000983/match=2027160/)).

Liverpool that night lined up 4-3-3 against Barcelona's 4-4-2, but where Barcelona in 2009 used the front three to hold width and the midfield to keep the ball, Klopp used the front three — Sadio Mané, the makeshift centre-forward Divock Origi (Roberto Firmino and Mohamed Salah both injured), and Xherdan Shaqiri — as the *first line of the press*. Fabinho sat as a lone pivot, the single screen at the base of the three, with Jordan Henderson and Georginio Wijnaldum as box-to-box 8s detonating forward the instant Liverpool won the ball. This is gegenpressing: counter-pressing the moment possession is lost, winning the ball back high up the pitch where one pass separates you from a chance. Across that 2018-19 season Liverpool averaged a PPDA — passes allowed per defensive action, the standard measure of pressing intensity — of 7.85 per Understat, the most intense average press of Klopp's Anfield reign to that point ([liverpool.com](https://www.liverpool.com/liverpool-fc-news/features/liverpool-jurgen-klopp-pressing-tactics-17292769)). Lower is more intense; for context, a mid-block side might sit comfortably in the low teens. The same season produced 97 league points and a European Cup, which is what that number buys you when it is held for ten months.
...
That is the deep reason every grave dug for the 4-3-3 stays empty. A formation is a starting position, not a strategy — and the 4-3-3 starts you in the right places more often than any other shape, which is why coaches as different as Guardiola, Klopp, Arteta and Carlo Ancelotti keep returning to it. Ancelotti's Real Madrid won the 2021-22 Champions League — the club's fourteenth — playing what was nominally a 4-3-3, and the final in Saint-Denis on 28 May 2022 shows the dialect exactly: Casemiro shielding, Luka Modrić and Toni Kroos beside him as deep-lying creators rather than gegenpressing 8s, Federico Valverde covering the right flank, and Vinícius Jr cutting inside from the left as an inverted winger to score the only goal ([en.wikipedia.org](https://en.wikipedia.org/wiki/2022_UEFA_Champions_League_final)). Same three bands, third language.
...
## Where does the 4-3-3 sit among the greatest teams ever?

Near the top, but never alone — the best sides pass through the 4-3-3 rather than live inside it. Brazil 1970 moved through the 4-3-3 as one shape among several, which is part of why they lead [the ranking of the greatest teams in football history](/chapters/football/greatest-football-teams-of-all-time).
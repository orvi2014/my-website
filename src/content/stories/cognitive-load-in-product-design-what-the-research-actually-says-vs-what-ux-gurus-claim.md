---
title: "Cognitive Load in UX: What the Research Actually Says"
...
John Sweller developed it for instructional design, [publishing the founding paper in *Cognitive Science* in 1988](https://doi.org/10.1207/s15516709cog1202_4). The classic result is the worked-example effect: hand a beginner a solved problem instead of a blank one and they learn faster. Then Kalyuga, Ayres, Chandler and Sweller published [the expertise reversal effect](https://www.tandfonline.com/doi/abs/10.1207/S15326985EP3801_4) in *Educational Psychologist* in 2003, showing that the same worked examples that help beginners actively hurt experienced learners. Scaffolding that lowers a novice's load turns into redundant material an expert has to read and then discard.
...
The founding study is the jam experiment: a California supermarket display of 24 jams pulled more foot traffic, stopping 60 percent of passers-by against 40 percent for a display of 6 — but the small display converted 30 percent of the people who stopped, against 3 percent for the large one ([Iyengar & Lepper, 2000, *Journal of Personality and Social Psychology*](https://doi.org/10.1037/0022-3514.79.6.995)). I've seen it in more product decks than I can count, usually alongside a stock photo of jam. I've also argued from it myself, at length, in [a piece on why SaaS pricing pages with more tiers convert worse](/chapters/psychology/the-paradox-of-choice-barry-schwartz-was-right-and-saas-products-keep-ignoring-it) — what follows is the strongest argument against the version I wrote there.
...
Now look at who supplies the rules. Conference talks, design-school curricula and the enormous middle layer of UX content are all rewarded for producing things that are memorable and teachable. "Cognitive load depends on prior knowledge, element interactivity and task type, and the direction of the effect reverses with expertise" is accurate and useless in a twenty-minute keynote. "Miller's Law" fits on a slide. Compression is the entire selection pressure, and compression is exactly what strips out the moderators, the populations and the error bars that made the finding true in the first place. The 21-day habit rule has [exactly this shape](/chapters/psychology/habit-formation-what-the-actual-science-says-vs-what-every-productivity-book-gets-wrong): one real observation, compressed past the point where it was still true, still in circulation decades after the measurement said otherwise.
...
The measurement gap closes the loop. [NASA-TLX](https://humansystems.arc.nasa.gov/groups/TLX/) has existed since 1988. It measures perceived workload across six dimensions and takes about two minutes. Almost no product team runs it. We instrument our interfaces for clicks, funnels and retention, then spend an hour arguing about a construct we've decided not to measure. Compare Baymard's benchmark work: the average US checkout shows [23.48 form elements by default](https://baymard.com/blog/ecommerce-checkout-usability-report-and-benchmark) against an achievable 12, with abandonment sitting at 70.19 percent. You can act on that. It's what the field produces when it counts things instead of citing them.

The obvious objection to all of this is that Snap failed because of habit disruption, not because load reduction is wrong. Fair enough. But habit disruption is the expertise reversal effect wearing a different hat, it was documented in 2003, and it means the principle as practitioners state it has no stable sign. Whether simplifying an interface helps or hurts depends on who is looking at it. Something that can point either way isn't a rule; it's a question you still have to go and answer. It's also the same trap I traced through [New Coke and Snapchat from the System 1 side](/chapters/psychology/kahneman-was-right-why-system-1-still-wins-every-product-decision), which is a different vocabulary for the same failure.

## How do you test a redesign before you ship it?

Split the rollout by how long people have used the product, not by geography, and read the two groups separately. Snap already had the number that predicted the failure, the 8 percent retention lift among the over-35s, and it arrived after the rollout instead of before it. Splitting the release by account tenure would have surfaced the trade in a week, on a small slice of the base, for essentially nothing.
...
If you want the rest of this argument from other angles: [why product redesigns fail even when they test well](/chapters/psychology/kahneman-was-right-why-system-1-still-wins-every-product-decision), [the case for fewer pricing tiers](/chapters/psychology/the-paradox-of-choice-barry-schwartz-was-right-and-saas-products-keep-ignoring-it) that the meta-analysis above complicates, [decision fatigue in product surfaces](/chapters/psychology/decision-fatigue-is-real-and-your-product-is-probably-making-it-worse), and [the endowment effect](/chapters/psychology/the-endowment-effect-why-users-never-delete-software-they-do-not-use), which is the other half of why people defend interfaces they've already learned.